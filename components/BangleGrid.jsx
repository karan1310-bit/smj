...
export default function BangleGrid() {
  return (
      ...
      <div className="max-w-9xl md:max-w-9xl mx-auto">
        ...
        <nav className="text-base text-gray-500 mb-2 md:mb-4">
          <ol className="list-reset flex space-x-2">
            ...
            <li>/</li>
            <li className="text-gray-800 font-medium">Bangles</li>
          </ol>
        </nav>

        {/* Page Header */}
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
          <h1 className="text-2xl sm:text-3xl font-semibold text-gray-800">Bangles</h1>
